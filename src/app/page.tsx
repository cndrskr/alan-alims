          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8 animate-fade-in-up">
              ...
              <p className="google-text-body google-text-secondary max-w-4xl mx-auto leading-relaxed">
                ...
                достижений ученых из Карачая и Балкарии. Мы стремимся показать
                вклад наших исследователей в развитие мировой науки и вдохновить
                молодое поколение на научную деятельность.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-6">
              <div
                className="google-card p-6 text-center animate-scale-in"
